 ...
 * @version 2.0
 */
public class HomeCountriesGoods implements Serializable{

	/**
	 * 序列化ID
	 */
	private static final long serialVersionUID = -2642733147495644336L;
	/**
	 * id
	 */
	private Integer id;
	...
	public String toString() {
		return "HomeCountriesGoods [id=" + id + ", titleID=" + titleID + ", titleName=" + titleName + ", type=" + type
				+ ", banner=" + banner + ", seat=" + seat + ", goodsID=" + goodsID + ", goodsShowName=" + goodsShowName
				+ ", goodsShowMap=" + goodsShowMap + ", operator=" + operator + ", updateTime=" + updateTime
				+ ", getId()=" + getId() + ", getTitleID()=" + getTitleID() + ", getTitleName()=" + getTitleName()
				+ ", getType()=" + getType() + ", getBanner()=" + getBanner() + ", getSeat()=" + getSeat()
				+ ", getGoodsID()=" + getGoodsID() + ", getGoodsShowName()=" + getGoodsShowName()
				+ ", getGoodsShowMap()=" + getGoodsShowMap() + ", getOperator()=" + getOperator() + ", getUpdateTime()="
