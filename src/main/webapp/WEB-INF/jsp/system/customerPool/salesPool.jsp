...
<html lang="en">
	...
	<body id="main-body">
		...
		<form method="post" action="salesPool.do" name="customerPoolServiceImpl" id="customerPoolServiceImpl" class="form-inline">
		<div id="main">
			<div class="main-box" id="new-main-box" style="min-width:1120px">
				<h2 class="title-h2" style="text-indent: 5%;">销售池</h2>
				<hr />
				<div class="title-br"><i>客服专属注册链接</i></div>
				<i class="link-r">${registerHttps}</i>
				<ul class="top-show">
					<li>
						<h2>￥${totalSales.todayTotalSales}</h2>
						<h5>今日销售</h5>
					</li>
					<li>
						<h2>￥${totalSales.thisWeekTotalSales}</h2>
						<h5>本周销售</h5>
					</li>
					<li>
						<h2>￥${totalSales.thisMonthTotalSales}</h2>
						<h5>30天销售</h5>
					</li>
					<li>
						<h2>￥${totalSales.thisYearTotalSales}</h2>
						<h5>本年销售</h5>
					</li>
				</ul>
				<div class="tab-list">
