...
<div id="main">
	<div class="main-box" id="new-main-box" style="min-width:800px">
		...
		<div class="title-list">
			<i class="active" style="border:0;text-align: left;padding-left: 0;">待审核</i>
				...
				<table class="table table-striped" style="border-bottom: 2px solid #e4e4e4;">
					<tbody>
						<tr class="tr-head">	
							...
							<td class="center">
								<a class="orderAD" onclick="order_c('lnput_time')"  href="javascript:;">提交时间<i class="icon-orderAD <c:if test="${pd.orderColumn == 'submit_time' && pd.orderAD == 'DESC'}">icon_down</c:if><c:if test="${pd.orderColumn == 'submit_time' && pd.orderAD == 'ASC'}">icon_up</c:if>"></i></a>
							</td>
