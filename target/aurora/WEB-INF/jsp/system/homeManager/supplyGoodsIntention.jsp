	...
	<body id="main-body">
		...
		<div id="main">
			<div class="main-box" style="min-width:800px">
				<h2 class="title-h2" style="text-indent: 5%;">商品供货意向</h2>
				<hr />
				<form method="post" action="supplyGoodsIntention.do" id="supplyGoodsIntention">
		...
		$(function(){
			...
			goodList = ${supplyGoodsIntentionList}
			page = ${page}
			intention = ${intention}
			new Vue({
				el:'.main-box',
				...
				methods:{
					delete_active:function(i){
						...
						layer.confirm('确认删除该条供货意向？',function(index){
								$.ajax({
							    type:'post',
							    url:'supplyGoodsIntention/deleteSupplyGoodsIntention',
							    data:{
							    	id:id
							    },
							    dataType:'json',
